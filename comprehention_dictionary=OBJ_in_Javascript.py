...
# Input data: List of DICTIONARIES = objeto em JAVASCRIPT
employee_list = [
...
def generate_usernames(mod_list):
   ...
   """
   ### WRITE SOLUTION CODE HERE
   new_list = [nickname.replace(' ', '_') for nickname in mod_list]
   return new_list
...
def map_id_to_initial(employee_list):
   ...
   """
   ### WRITE SOLUTION CODE HERE
   dict_id = {emp['name'][0] : emp['id'] for emp in employee_list}
   return dict_id
